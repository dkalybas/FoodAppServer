...
public class ShipperViewModel extends ViewModel implements IShipperLoadCallbackListener {
    ...
    public void setShipperMutableList(MutableLiveData<List<ShipperModel>> shipperMutableList) {
        this.shipperMutableList = shipperMutableList;
    }
    ...
    @Override
    public void onShipperLoadSuccess(int pos, OrderModel orderModel, List<ShipperModel> tempList, AlertDialog dialog, Button btn_ok, Button btn_cancel, RadioButton rdi_shipping, RadioButton rdi_shipped, RadioButton rdi_cancelled, RadioButton rdi_delete, RadioButton rdi_restore_placed) {
